    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if($responseKey['success'])
        {
            if($unameOK == true && $passwordOK == true && $fnameOK == true && $lnameOK == true && $emailOK == true)
            {
                ...
                $sql = "INSERT INTO user (uname, pass, fname, lname, email)
                VALUES ('$uname', '$passHash', '$fname', '$lname', '$email')";
        ...
        <div class="login-page reg-page">
            <div class="form">
                ...
                <form class="login-form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                    ...
                    <input type="text" name="uname" placeholder="Tên đăng nhập" value="<?php echo $uname;?>"/>
                    <span class="FirstName-Error"><?php echo $fnameCriteria;?></span>
                    <input type="text" name="fname" placeholder="Họ" value="<?php echo $fname;?>"/>
                    <span class="LastName-Error"><?php echo $lnameCriteria;?></span>
                    <input type="text" name="lname" placeholder="Tên" value="<?php echo $lname;?>"/>
                    ...
                    <div class="g-recaptcha" data-sitekey="6Ld1nA0aAAAAAA7F7eJOY7CMwg7aaQAfg3WZy6P0"></div>
                    <button>Join</button>
