        ...
        <section class="featured section" id="featured">
            ...
            <div class="row category-title">
                ...
                <div class="dropdown col-auto">
                    <button class="dropbtn button" id="cat-but">Sắp xếp theo <i class='bx bxs-down-arrow drop-arrow'></i></button>
                    <div class="dropdown-content">
                        <a href="#" onclick="sortby_products(1)">Giá từ thấp đến cao</a>
                        <a href="#" onclick="sortby_products(2)">Giá từ cao đến thấp  </a>
                ...
                <!--========== CATEGORIES BUTTON ==========-->
                <div class="dropdown col-auto">
                    <button class="dropbtn button" id="cat-but">Danh mục bánh<i class='bx bxs-down-arrow drop-arrow'></i></button>
                    <div class="dropdown-content">
                        <?php
        ...
        <section class="offer section">
            <div class="offer__bg">
                <div class="offer__data">
                    ...
                    <p class="offer__description">SIÊU ƯU ĐÃI CHO KHÁCH HÀNG MỚI</p>

                    <a href="#" class="button button__round">Mua ngay</a>
                </div>
            </div>
        </section>
        <!--End Special Offer-->
            ...
            <script>
                ...
                function display_products_by_type(p_type){
                    ...
                    if(p_type==1){
                        ...
                        document.getElementById('small_title').innerHTML = 'Tất cả';
                    }
                    else  if(p_type==3){
                    ...
                    //BIG TITLE
                    document.getElementById('big_title').innerHTML = 'Sản phẩm';
                ...
                function display_products_by_type_second(p_type){
                    ...
                    if(p_type==1){
                        document.getElementById('small_title2').innerHTML = 'Ra lò';
                    }
                    else  if(p_type==2){
                    ...
                    //BIG TITLE
                    document.getElementById('big_title2').innerHTML = 'Sản phẩm mới';
