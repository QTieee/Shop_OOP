...
<html>
    ...
    <?php 
        ...
        include_once 'umodels/numOfItemsInCartModel.php';
        ?>
        ...
        <div class="row mx-auto">
            ...
            <div class="col-lg">
                ...
                <div class="cart_title_bar mx-1 ">
                    ...
                    <div class="cart-title-2">
                        <h4 class="section-all my-0 py-0 hide-wave">Chi tiết sản phẩm</h4>
                    </div>
                    <div class="cart-title-3">
                        <h4 class="section-all my-0 py-0 hide-wave">Số lượng</h4>
                    </div>
                   
                    <div class="cart-title-4">
                        <h4 class="section-all my-0 py-0 hide-wave">Tổng tiền</h4>
                    </div>
                    <div class="cart-title-5">
                        <h4 class="section-all my-0 py-0 hide-wave">Xóa</h4>
                    </div>
                ...
                <div class="receipt-card mt-2 mb-3 mx-1 py-3">
                    ...
                    <div class="tot-price-per-item ">
                        <h6><?php echo number_format($product['quantity'] * $product['price']); ?> VNĐ</h6>
                    </div>
            ...
            <div class="col-md container receipt-area mx-auto">
                ...
                <div class="row summary-area">
                    <h1 class="subtitle">Hóa đơn</h1>
                </div>
                <div class="row container receipt-data mx-auto pt-3">
                    <!-- subtotal -->
                    <div class="row container subtotal-area my-1">
                        <div class="col">
                            <h4 class="subtitle title-checkout">Tiền bánh: </h4>
                        </div>
                        
                        <div class="col">
                            <h4 class="subtitle"><?php echo number_format($total); ?> VNĐ</h4>
                        </div>
                    </div>
                    <!-- delivery -->
                    <div class="row container delivery-area my-1">
                        <div class="col">
                            <h4 class="subtitle title-checkout">Phí vận chuyển: </h4>
                        </div>
                        
                        <div class="col">
                            <h4 class="subtitle">0.00 VNĐ</h4>
                        </div>
                    </div>
                    <!-- total -->
                    <div class="row container total-area my-1 pt-2">
                        <div class="col">
                            <h4 class="subtitle title-checkout">Tổng tiền: </h4>
                        </div>
                    ...
                    <div class="row checkout-area">
                        <a href="404.html">
                            <button type="button" class="btn btn-primary btn-lg my-4 button">Thanh toán</button>
                        </a>
                    </div>
                    <?php
                     }//end count if
                     if(count($_SESSION['shopping_cart']) == 0) {
                        echo('<h1 class="subtitle">Hãy chọn chiếc bánh yêu thích của bạn !</h1>');
                     }
                    }//end isset if
                    if(!isset($_SESSION['shopping_cart'])) {
                        echo("<h1 class='subtitle'>Hãy chọn chiếc bánh yêu thích của bạn !</h1>");
            ...
            <?php  
                ...
                if(isset($_SESSION['shopping_cart'])) {
                    if(count($_SESSION['shopping_cart']) == 0) {
                        ...
                        echo('<h1 class="text-center my-3">Hãy chọn chiếc bánh yêu thích của bạn !</h1>');
