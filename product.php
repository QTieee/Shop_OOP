<?php 
    ...
    if (!isset($_SESSION['uname']) && isset($_POST['add-to-cart'])) {
        // Chuyển hướng sang trang đăng nhập
        header("Location: login.php"); // Thay 'login.php' bằng URL của trang đăng nhập của bạn
        ...
        <div class="container mx-auto mt-0 pt-0 ">
            <!-- <form method="POST" action="index.php?action=add&id=<?php //echo $product_id; ?>"> -->
                <div class="row continue-shop-div text-center">
                    <a href="products.php" class="button continue" id="cat-but" >Chọn Thêm</a>
                    ...
                    <div class="col mt-4">
                        ...
                        <form id="form-pd" method="POST" action="product.php?action=add&product_id=<?php echo $product_id; ?>">
                            <div class="box my-4">
                                ...
                                margin-bottom: .8rem; font-weight: 700; color: grey; ">Số lượng</label><br>
                                ...
                                <input type="submit" name="add-to-cart" id="add-to-cart-btn" value="Thêm vào giỏ" class="btn btn-primary btn-lg my-4 button" />
